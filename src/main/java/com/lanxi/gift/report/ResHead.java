...
//	}
	...
	public DOMElement toElement() {
		...
		element.addElement("VER").setText(CheckReplaceUtil.nullAsSpace(getVer()));
		element.addElement("MsgNo").setText(CheckReplaceUtil.nullAsSpace(getMsgNo()));
		element.addElement("CHKDate").setText(CheckReplaceUtil.nullAsSpace(getChkDate()));
		element.addElement("WorkDate").setText(CheckReplaceUtil.nullAsSpace(getWorkDate()));
		element.addElement("WorkTime").setText(CheckReplaceUtil.nullAsSpace(getWorkTime()));
		element.addElement("ADD").setText(CheckReplaceUtil.nullAsSpace(getAdd()));
		element.addElement("SRC").setText(CheckReplaceUtil.nullAsSpace(getSrc()));
		element.addElement("DES").setText(CheckReplaceUtil.nullAsSpace(getDes()));
		element.addElement("APP").setText(CheckReplaceUtil.nullAsSpace( getApp()));
		element.addElement("MsgID").setText(CheckReplaceUtil.nullAsSpace(getMsgId()));
		element.addElement("Reserve").setText(CheckReplaceUtil.nullAsSpace(getReserve()));
		element.addElement("Sign").setText(CheckReplaceUtil.nullAsSpace(getSign()));
